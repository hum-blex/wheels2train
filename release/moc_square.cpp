...
QT_MOC_LITERAL(1, 7, 18), // "CollidedWithSquare"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 4) // "move"

    },
    "Square\0CollidedWithSquare\0\0move"
};
...
void Square::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->CollidedWithSquare((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Square::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Square::CollidedWithSquare)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Square::CollidedWithSquare(int _t1)
{
