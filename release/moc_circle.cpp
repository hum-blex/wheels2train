...
QT_MOC_LITERAL(1, 7, 18), // "CollidedWithCircle"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 13), // "ReachedTheEnd"
QT_MOC_LITERAL(4, 41, 4) // "move"

    },
    "Circle\0CollidedWithCircle\0\0ReachedTheEnd\0"
    "move"
};
...
void Circle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->CollidedWithCircle(); break;
        case 1: _t->ReachedTheEnd((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Circle::CollidedWithCircle)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Circle::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Circle::ReachedTheEnd)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Circle::CollidedWithCircle()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Circle::ReachedTheEnd(int _t1)
{
